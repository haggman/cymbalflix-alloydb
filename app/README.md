...
Click the **Web Preview** button (square with arrow icon in Cloud Shell toolbar) and select **Preview on port 8501**.

## App Structure

```
cymbalflix-alloydb/app
